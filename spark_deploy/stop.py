...
def stop(reservation, install_dir=install_defaults.install_dir(), key_path=None, worker_workdir=start_defaults.workdir(), use_sudo=False, silent=False, retries=defaults.retries()):
