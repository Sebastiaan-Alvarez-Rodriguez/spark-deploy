...
def deploy(parsers, args):
    ...
    return _start.start(reservation, args.installdir, args.key_path, args.master_id, master_port=args.master_port, webui_port=args.webui_port, slave_workdir=args.workdir, silent=args.silent, retries=args.retries) if reservation else False